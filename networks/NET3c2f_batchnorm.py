...
def neuralnetwork(x):
    ...
    with tf.name_scope('conv1_bn'):
        y_conv1_bn = tf.layers.batch_normalization(y_conv1)
    ...
    with tf.name_scope('conv2_bn'):
        y_conv2_bn = tf.layers.batch_normalization(y_conv2)
        
    with tf.name_scope('pool3'):
        y_pool3 = max_pool_2x2(y_conv2_bn)
    ...
    with tf.name_scope('conv3_bn'):
        y_conv3_bn = tf.layers.batch_normalization(y_conv3)
        
    with tf.name_scope('pool4'):
        y_pool4 = max_pool_2x2(y_conv3_bn)
